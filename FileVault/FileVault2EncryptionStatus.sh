...
# https://github.com/rtrouton/rtrouton_scripts/blob/master/rtrouton_scripts/filevault_2_encryption_check/Casper%20Extension%20Attribute/filevault_2_encryption_check_extension_attribute.sh
